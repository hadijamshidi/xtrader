...
class Ratio(models.Model):
    StockWatch = models.ForeignKey(StockWatch,verbose_name='سهم ')
    InstrumentName = models.CharField(max_length=80)
    current_ratio = models.IntegerField(verbose_name='جاری',null=True,blank=True)
    quick_ratio = models.IntegerField(verbose_name='آنی',null=True,blank=True)
    cash_ratio = models.IntegerField(verbose_name='نقد',null=True,blank=True)
    da = models.IntegerField(verbose_name='بدهی (درصد)',null=True,blank=True)
    de = models.IntegerField(verbose_name='بدهی به ح ص س',null=True,blank=True)
    sa = models.IntegerField(verbose_name='گردش دارای (بار)',null=True,blank=True)
    accounts_receivable_turnover_ratio =models.IntegerField(verbose_name='دوره گردش دریافتنی (روز)',null=True,blank=True)
    accounts_payable_turnover_ratio=models.IntegerField(verbose_name='حاشیه سود خالص (درصد)',null=True,blank=True)
    inventory_turnover_ratio = models.IntegerField(verbose_name='دوره گردش موحودی ',null=True,blank=True)
    profit_margin = models.IntegerField(verbose_name='حاشیه سود خالص (درصد)',null=True,blank=True)
    gross_profit_margin = models.IntegerField(verbose_name='حاشیه سود ناخالص (درصد)',null=True,blank=True)
    ebit_gross_profit = models.IntegerField(verbose_name='سود عملیاتی به سود ناخالص (درصد)',null=True,blank=True)
    r_ebit = models.IntegerField(verbose_name='هزینه بهره به سود عملیاتی (درصد)',null=True,blank=True)
    roa = models.IntegerField(verbose_name='بازده دارایی (درصد)',null=True,blank=True)
    roe = models.IntegerField(verbose_name='بازده ح ص س (درصد)',null=True,blank=True)